...
export default function SavedRoutes({ onLoadRoute, refreshTrigger }: SavedRoutesProps) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="absolute top-14 right-0 w-80 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden animate-in slide-in-from-top-2 duration-200">
